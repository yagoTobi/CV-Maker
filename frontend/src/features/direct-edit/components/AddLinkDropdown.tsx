...
const PRESETS: LinkPreset[] = [
  { label: 'LinkedIn',       url: 'https://linkedin.com/in/',                        icon: <LinkedInIcon /> },
  { label: 'GitHub',         url: 'https://github.com/',                             icon: <GitHubIcon /> },
  { label: 'Portfolio',      url: 'https://yourname.com',                            icon: <GlobeIcon /> },
  { label: 'Google Scholar', url: 'https://scholar.google.com/citations?user=',      icon: <ScholarIcon /> },
  { label: 'Custom',         url: 'https://',                                        icon: <LinkIcon /> },
];
