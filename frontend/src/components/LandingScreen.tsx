      ...
      <div className={styles.content}>
        <div className={styles.branding}>
          ...
          <p className={styles.subtitle}>
            Create and tailor your CV with AI assistance
          </p>
        </div>
          ...
          <div className={styles.cards}>
            ...
            >
              ...
              <div className={styles.cardBody}>
                <h2>Build my CV</h2>
                <p>
                  Start from scratch. Fill in your details with a guided form and
            ...
            >
              ...
              <div className={styles.cardBody}>
                ...
                <p>
                  Already have a CV? Paste a job description and let AI help you
            ...
            >
              ...
              <div className={styles.cardBody}>
                ...
                <p>
                  Upload a PDF, Word doc, or JSON export and we&apos;ll extract your
            ...
            >
              ...
              <div className={styles.cardBody}>
                ...
                <p>
                  Let AI help you craft a compelling cover letter that highlights
