...
- [x] **ROUTE-03**: Dashboard version switching loads selected version into web CV editor
- [x] **ROUTE-04**: Template selection navigates to web CV editor (not form builder)
- [x] **ROUTE-05**: Build flow end-to-end works: Landing -> Template Select -> Web CV Editor -> Download PDF

### Streamlined Tune Flow

- [ ] **TUNE-01**: Save-as-base prompt appears only when activeVersion is null (unsaved CV); skipped when CV is already saved
- [ ] **TUNE-02**: Entire tune flow lives in a right panel on /build/form with 3 progressive tiers (save-as-base, job details, diff review)
- [ ] **TUNE-03**: Completed tiers collapse to clickable summary rows; re-expanding preserves form state
- [ ] **TUNE-04**: Tier 3 reuses existing ChangePanel/ChangeCard components and useTailor hook for diff review
- [ ] **TUNE-05**: /apply route redirects to /build/form with tune panel open; all navigation entry points updated
- [x] **TUNE-06**: ApplyToJobScreen component removed and replaced by inline TunePanel
- [ ] **TUNE-07**: After saving tailored CV, navigate to Dashboard filtered to show only that base CV group
- [ ] **TUNE-08**: NavBar shows tuning-active indicator when tune panel is open
- [ ] **TUNE-09**: "+ New CV" button removed from NavBar on all non-editor pages
...
| ROUTE-03 | Phase 6: Route Integration | Complete |
| ROUTE-04 | Phase 6: Route Integration | Complete |
| ROUTE-05 | Phase 6: Route Integration | Complete |
| TUNE-01 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-02 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-03 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-04 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-05 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-06 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-07 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-08 | Phase 8: Streamlined Tune Flow | Planned |
| TUNE-09 | Phase 8: Streamlined Tune Flow | Planned |
